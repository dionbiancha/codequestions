...
export function FocusMode({ question, onNext, onPrev, hasPrev, onClose }: Props) {
  ...
  return createPortal(
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between px-6 py-4 border-b border-blue-500/20 bg-blue-500/5 flex-shrink-0">
      ...
      {/* Footer */}
      <div className="flex items-center justify-center gap-4 px-6 py-4 border-t border-dark-border flex-shrink-0">
        <button
          onClick={onPrev}
          disabled={!hasPrev}
