    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      {!revealed ? (
        <button
          ...
          className="mb-6 inline-flex items-center gap-2 border border-dark-border hover:border-blue-500/50 text-dark-muted hover:text-dark-heading text-sm px-4 py-2 rounded-lg transition-colors"
        >
          {t('revealAnswer')}
        </button>
      ) : (
        <div className="mb-6 bg-dark-surface border border-dark-border rounded-lg px-4 py-3">
